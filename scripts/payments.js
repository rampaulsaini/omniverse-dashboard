// scripts/payments.js
// Small helper: show donation links to user by reading stored owner config in localStorage
(function(){
  function showPaymentOptions(){
    const cfg = JSON.parse(localStorage.getItem('omni_pay_config')||'{}');
    let html = '<div class="card"><h4>Donate / Pay</h4>';
    if(cfg.paypal) html += `<div><a class="btn" href="${cfg.paypal}" target="_blank">Pay via PayPal</a></div>`;
